...
- [x] [P8-T5] Compare the Phase 0 baseline (`evidence/baseline/phase0-baseline-04-dotnet-test-coverage.md`) against the Phase 8 post-change coverage (`evidence/qa-gates/final-qa-04-dotnet-test-coverage.md`) and write `docs/features/active/2026-07-07-graph-activity-log-purview-124/evidence/qa-gates/final-qa-05-coverage-delta.md` reporting baseline vs. post-change line/branch percentages, the delta, the >=85%/>=75% threshold check, and per-new-file line/branch coverage for every production file added in Phases 1–5.
