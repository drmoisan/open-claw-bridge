...
Both services (`openclaw-agent` and `openclaw-core`) are present. The `openclaw-agent` service does NOT yet have `env_file: ./secrets/.env.anthropic` — this is the gap that P1-T4 will close.
