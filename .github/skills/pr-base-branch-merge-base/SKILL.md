...
Use this skill when:
- running `VS Code command: `drm-copilot: Collect PR Context` (command ID: `drmCopilotExtension.collectPrContext`)`,
...
- `VS Code command: `drm-copilot: Collect PR Context` (command ID: `drmCopilotExtension.collectPrContext`) --base <resolved-PRBaseBranch>`
